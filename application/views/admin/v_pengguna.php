...
<head>
    ...
    <title>Socamedia | Pengguna</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2017 Socamedia.</strong> All rights reserved.
        </footer>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="xlinkedIn" class="form-control" id="inputLinkedIn" placeholder="LinkedIn" required>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="inputLinkedIn" class="col-sm-4 control-label">LinkedIn</label>
                            <div class="col-sm-7">
                                <input type="text" name="xlinkedIn" class="form-control" id="inputLinkedIn" placeholder="LinkedIn" value="<?php echo $pengguna_linkdin;?>" required>
                            </div>
                        </div>
