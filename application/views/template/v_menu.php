<section class="menu cid-qLBibMV2b0" once="menu" id="menu1-y">
	<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
			...
			<div class="navbar-brand">
				<span class="navbar-logo">
					<a href="<?php echo base_url().''?>">
						<img src="<?php echo base_url().'assets-socamedia/images/s-white-122x122.png'?>" alt="Socamedia" title="" style="height: 3.8rem;">
					</a>
				</span>
				<span class="navbar-caption-wrap">
					<a class="navbar-caption text-white display-5" href="<?php echo base_url().''?>">
						Socamedia.id
					</a>
				</span>
			</div>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
				...
				<li class="nav-item">
					<a class="nav-link link text-white display-4" href="<?php echo base_url().'about'?>">
				...
				<li class="nav-item">
					<a class="nav-link link text-white display-4" href="<?php echo base_url().'Administrator'?>">
